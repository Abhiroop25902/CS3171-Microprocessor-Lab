...
\lstset{
    ...
    morekeywords={*,MVI,DAD,INX,DCR,LXI,DCX,ORA,LDAX,ANI,INR,LHLD,RAL,SIM,RIM,XTHL,...},               % if you want to add more keywords to the set
...
\section[Subroutine to save Register Status]{Assignment 9} %[toc content]{text content}
    ...
    %     We use bubble sort algorithm to sort the array.
    \subsection{Program}
        \lstinputlisting[caption=assembly program to bubble sort array]{./../Programs/Assignment 3/3_3_store_all_reg.asm}
        \newpage
    \subsection{Experimentation}
        \begin{figure}[h!]
            \centering

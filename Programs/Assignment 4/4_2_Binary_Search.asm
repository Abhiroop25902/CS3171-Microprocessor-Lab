...
END:	   CMC	// Complement the carry flag
	   HLT	// Halt
...
NOCARRY:	   RAR	// Rotate Accumulator right by 1 bit (A = A >> 1) i.e A = (B+C)/2
	   MOV E,A
...
NOPE:	   MOV A,D	// Accumulator now has the number we are looking for
